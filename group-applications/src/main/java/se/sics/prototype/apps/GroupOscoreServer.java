...
public class GroupOscoreServer {
     ...
     * @param config
     */
    private static void createEndpointsOld(CoapServer server, InetAddress multicastIP, int unicastPort, int multicastPort,
     ...
     * @param connector
     */
    private static void createReceiverOld(UdpMulticastConnector.Builder builder, UDPConnector connector) {
	 ...
	 * @param config
	 */
	private static void createEndpoints(CoapServer server, int unicastPort, int multicastPort,
			Configuration config, InetAddress multicastIP) {
		// UDPConnector udpConnector = new UDPConnector(new
		// InetSocketAddress(unicastPort));
		// udpConnector.setReuseAddress(true);
		// CoapEndpoint coapEndpoint = new
