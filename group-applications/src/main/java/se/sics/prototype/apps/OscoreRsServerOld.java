 ...
 *
 */
public class OscoreRsServerOld {
...
//        
//        // Rikard
//        // Adding the join resource for the first group (Group A) in the demo.
...
//        
//        // Rikard
//        // Adding the join resource for the second group (Group B) in the demo.
...
//        myScopes.put("bbbbbb570000_requester_monitor", myResource6);
        ...
        //The original feedca570000 group and Group A and B for the demo
        ...
        // Also adds resources for the 2 groups in the demo
...
//        ai.processMessage(new LocalMessage(0, null, null, payload));
    ...
    public static class GroupOSCOREJoinResourceOLD extends CoapResource {
        ...
        public void handlePOST(CoapExchange exchange) {
            ...
            //Else if a server member is trying to join the demo Group A or Group B take a 1 byte unused value
    ...
    private static void OSCOREGroupCreation(String groupName, int signKeyCurve, int ecdhKeyCurve) throws CoseException
    {
        ...
        //Use a different master secret for demo Group B
