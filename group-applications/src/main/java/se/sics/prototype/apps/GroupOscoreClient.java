...
//
//	private final static byte[] gm_public_key_bytes = hexStringToByteArray(
...
//	private final static byte[] sid_public_key_bytes = hexStringToByteArray(
...
//	private static byte[] rid1_public_key_bytes = hexStringToByteArray(
...
//	private final static byte[] rid2_public_key_bytes = hexStringToByteArray(
...
//		// ================================
		...
		while(!command.equals("q")) {
			...
			if(useOSCORE) {
				multicastRequest.getOptions().setOscore(Bytes.EMPTY); //Set the OSCORE option
			}
