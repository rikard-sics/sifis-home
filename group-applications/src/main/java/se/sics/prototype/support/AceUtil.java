...
public class AceUtil {
    ...
    public static int addGroupOSCORERole (int currentRoleSet, short newRole) throws Exception{
   	 ...
   	 if (newRole < 1) throw new Exception("Invalid identifier of Group OSCORE role");
     ...
     * 
      ...
      * @throws AceException  if the role identifier is less than 1
     */
    public static int removeGroupOSCORERole (int currentRoleSet, short oldRole) throws Exception{

   	 if (oldRole < 1) throw new Exception("Invalid identifier of Group OSCORE role");
     ...
     * 
      ...
      * @throws AceException  if the role identifier is less than 1
     */
    public static boolean checkGroupOSCORERole (int roleSet, short role) throws Exception {

   	 if (role < 1) throw new Exception("Invalid identifier of Group OSCORE role");
    ...
    public static Set<Integer> getGroupOSCORERoles (int roleSet) throws Exception {
   	 
   	 if ((roleSet % 2) == 1) throw new Exception("Invalid identifier of Group OSCORE role");
